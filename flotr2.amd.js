    ...
    Flotr.addType('gantt', {
        ...
        draw: function(series) {
            ...
            if (series.gantt.fill) {
                ...
                ctx.fillStyle = this.processColor(color, {
                    opacity: series.gantt.fillOpacity
                });
            }
        ...
        Flotr.addType('markers', {
            ...
            _plot: function(x, y, label, options) {
                ...
                if (isImage(label))
                    ...
                    Flotr.drawText(context, label, left + margin, top + margin, {
                        textBaseline: 'top',
                        textAlign: 'left',
                        size: options.fontSize,
                        color: options.color
                    ...
                    if (axis.options.showLabels && (isFirst ? true : axis.used)) {
                        for (i = 0; i < axis.ticks.length; ++i) {
                            ...
                            html += [
                                ...
                                'top:' + top + 'px; ', ((!isX && !isFirst) ? 'right:' : 'left:') + left + 'px; ',
        ...
        Flotr.addPlugin('spreadsheet', {
            ...
            callbacks: {
                'flotr:afterconstruct': function() {
                    ...
                    D.setStyles(container, {
                        top: this.canvasHeight - offset + 'px'
                    });
        ...
        Flotr.addPlugin('titles', {
            ...
            drawTitles: function() {
                ...
                if (!options.HtmlText && this.textEnabled) {
                    ...
                    if (a.x.options.title && a.x.used)
                        html.push(
                            '<div style="position:absolute;top:', (this.plotOffset.top + this.plotHeight + options.grid.labelMargin + a.x.titleSize.height),
                    ...
                    if (a.y.options.title && a.y.used)
                        html.push(
                            '<div style="position:absolute;top:', (this.plotOffset.top + this.plotHeight / 2 - a.y.titleSize.height / 2),
