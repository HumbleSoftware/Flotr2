...
Flotr.addPlugin('titles', {
  ...
  drawTitles : function () {
    ...
    if (!options.HtmlText && this.textEnabled) {
      ...
      // SP: 2012/05/09 Removed class reference as this overrides inner classes when not defined
      // class="flotr-axis-title" 
      html.push('<div style="font-weight:bold;">');
      
      // Add x axis title
      if (a.x.options.title && a.x.used)
// SP: 2012/05/09 Changed class reference from flotr-axis-title to flotr-axis-title-x1      
        html.push(
          ...
          'px;text-align:', a.x.options.titleAlign, ';" class="flotr-axis-title-x1">', a.x.options.title, '</div>'
        );
      
      // Add x2 axis title
      if (a.x2.options.title && a.x2.used)
// SP: 2012/05/09 Changed class reference from flotr-axis-title to flotr-axis-title-x2      
        html.push(
          '<div style="position:absolute;top:0;left:', this.plotOffset.left, 'px;width:', 
          this.plotWidth, 'px;text-align:', a.x2.options.titleAlign, ';" class="flotr-axis-title-x2">', a.x2.options.title, '</div>'
        );
      
      // Add y axis title
      if (a.y.options.title && a.y.used)
// SP: 2012/05/09 Changed class reference from flotr-axis-title to flotr-axis-title-y1      
        html.push(
          '<div style="position:absolute;top:', 
          (this.plotOffset.top + this.plotHeight/2 - a.y.titleSize.height/2), 
          'px;left:0;text-align:', a.y.options.titleAlign, ';" class="flotr-axis-title-y1">', a.y.options.title, '</div>'
        );
      
      // Add y2 axis title
      if (a.y2.options.title && a.y2.used)
// SP: 2012/05/09 Changed class reference from flotr-axis-title to flotr-axis-title-y2      
        html.push(
          '<div style="position:absolute;top:', 
          (this.plotOffset.top + this.plotHeight/2 - a.y.titleSize.height/2), 
          'px;right:0;text-align:', a.y2.options.titleAlign, ';" class="flotr-axis-title-y2">', a.y2.options.title, '</div>'
        );
